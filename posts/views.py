...
class SuscribirseView(LoginRequiredMixin, View):
...
class DesuscribirseView(LoginRequiredMixin, View):
    def post(self, request, category_id):
        category = get_object_or_404(Category, id=category_id)
...
class MisCategoriasView(LoginRequiredMixin, ListView):
    template_name = 'suscribers/mis_categorias.html'
